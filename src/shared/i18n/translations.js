  ...
  en: {
    ...
    productDetail: {
      ...
      downloads: {
        ...
        externalMaterial: 'Reference material',
        externalMaterialCopy:
          'Links to documentation, datasheets and reference sites for this unit. They open in a new tab.',
        externalKindPage: 'Web page',
      },
      blogs: {
        title: 'Related reading',
        subtitle: 'Guides, technical notes and use cases featuring this unit.',
        cta: 'Read note',
      },
      reviews: {
        title: 'Comments',
        one: 'comment',
        many: 'comments',
        empty: 'No comments about this unit yet.',
        ratingLabel: 'Your rating',
        commentLabel: 'Your comment',
        placeholder: 'Tell us how the unit worked for you.',
        moderationNote: 'Published after approval.',
        submit: 'Post comment',
        sending: 'Sending…',
        thanks: 'Thanks. Your comment goes live once the Kolortec team approves it.',
        pendingBadge: 'Awaiting approval',
        loginPrompt: 'Comments are for registered customers. Sign in to leave yours.',
        loginCta: 'Sign in',
        errorRating: 'Pick a rating from 1 to 5 stars.',
        errorAuth: 'You need to sign in to comment.',
        errorRate: 'You sent several comments in a row. Try again in a while.',
        errorGeneric: 'We could not send your comment. Please try again.',
      },
    },
    distributors: {
      eyebrow: 'Distributor Program',
  ...
  es: {
    ...
    productDetail: {
      ...
      downloads: {
        ...
        externalMaterialCopy:
          'Enlaces a documentacion, fichas y sitios de referencia de este equipo. Se abren en una pestaña nueva.',
        externalKindPage: 'Pagina',
      },
      blogs: {
        title: 'Notas relacionadas',
        subtitle: 'Guias, notas tecnicas y casos de uso donde aparece este equipo.',
        cta: 'Leer nota',
      },
      reviews: {
        title: 'Comentarios',
        one: 'comentario',
        many: 'comentarios',
        empty: 'Todavia no hay comentarios sobre este equipo.',
        ratingLabel: 'Tu puntuacion',
        commentLabel: 'Tu comentario',
        placeholder: 'Contanos como te fue con el equipo.',
        moderationNote: 'Se publica despues de ser aprobado.',
        submit: 'Publicar comentario',
        sending: 'Enviando…',
        thanks: 'Gracias. Tu comentario se publica una vez aprobado por el equipo de Kolortec.',
        pendingBadge: 'Pendiente de aprobacion',
        loginPrompt: 'Los comentarios son de clientes registrados. Inicia sesion para dejar el tuyo.',
        loginCta: 'Iniciar sesion',
        errorRating: 'Elegi una puntuacion de 1 a 5 estrellas.',
        errorAuth: 'Tenes que iniciar sesion para comentar.',
        errorRate: 'Mandaste varios comentarios seguidos. Proba de nuevo en un rato.',
        errorGeneric: 'No pudimos enviar tu comentario. Intenta de nuevo.',
      },
    },
    distributors: {
      eyebrow: 'Programa de distribuidores',
