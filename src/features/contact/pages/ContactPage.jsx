  ...
  return (
    <section className="min-h-screen bg-[#050505] px-6 py-[42px] lg:px-40">
      ...
      <div className="grid max-w-[640px] gap-2">
        ...
        <input id="mail" placeholder={t('contactPage.emailPlaceholder', 'hola@dominio.com')} className="rounded-[8px] border border-[#2c2c2c] bg-[#101010] p-3 text-white" />
        <label htmlFor="msg" className="text-sm text-[#d7dbe2]">{t('contactPage.messageLabel', 'Mensaje')}</label>
        <textarea id="msg" rows="5" placeholder={t('contactPage.messagePlaceholder', 'Contanos qué necesitás...')} className="rounded-[8px] border border-[#2c2c2c] bg-[#101010] p-3 text-white" />
